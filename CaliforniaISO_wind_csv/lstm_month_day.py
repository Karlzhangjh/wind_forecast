...
def load_data_wind(files_name, time_steps):
	reframed_data = range(len(files_name))
	...
	for file in files_name:
		...
		reframed_data[years] = temp_data

	for i in range(len(files_name)):
		print('the shape of reframed_data',reframed_data[i].shape)
		#print(reframed_data[i])

	wind_total_day = reframed_data[0]
	for i in range(1,len(files_name)):
		wind_total_day = concatenate((wind_total_day,reframed_data[i]),axis=1)
		
	wind_total_day = wind_total_day.reshape(wind_total_day.shape[1],wind_total_day.shape[0])
	print('the shape of wind_total_day',wind_total_day.shape)
	print(wind_total_day) #(3058, 24)
	...
	print(wind_total_line) #(3058, 24)
	#supervised_data = series_to_supervised(wind_total_day,1,time_steps)
	#print(supervised_data)


	#print('the shape of reframed_data',reframed_data[years].shape)
	#print(reframed_data[years])
...
if __name__ == '__main__':
	...
	load_data_wind(files,time_steps)
	'''
